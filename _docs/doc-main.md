...
noDocBottom: true
noDocPaginate: true
noDocTitle: true       # this page renders its own hero in content
relatedDocs: true
---

<div class="doc-home-intro">
  <h1>Documentation</h1>
  <p>Pick the path that fits where you are.</p>
</div>

<nav class="doc-paths" aria-label="Pick your starting point">

  <a class="doc-path" href="{{ '/docs/doc-theory-foundations/' | relative_url }}">
  ...
  <a class="doc-path" href="{{ '/docs/doc-selection-criteria/' | relative_url }}">
...
<p class="doc-home-footer-note">All documentation pages are also listed in the sidebar to the left.</p>
