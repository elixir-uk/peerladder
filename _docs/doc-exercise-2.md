...
<blockquote class="media notice notice-success">
    ...
    <div class="media-body">
        ...
        <p>About 20–30 minutes and a way to take notes. Your notes from Pre-exercise 1 are handy but not essential.</p>
    </div>
</blockquote>
...
4. **Record your goals** in the [matching form]({{ "/docs/doc-matching-form/" | relative_url }}) and keep them to bring to the first session.
