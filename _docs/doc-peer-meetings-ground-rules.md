...
navbar:
    right_nav_tool: true
tags: [peer meetings, ground rules]
custom_js:
...
Whatever format the group picks, every meeting follows the same arc. Keeping the
bookends fixed is part of what makes the group feel predictable and safe.
